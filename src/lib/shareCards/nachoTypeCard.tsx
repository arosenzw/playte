    ...
    <div style={flex({ width: 1080, height: 1920, background: "#FFF8EE", flexDirection: "column", alignItems: "center", fontFamily: "Poppins", position: "relative" })}>
      ...
      <div style={flex({ flexDirection: "column", alignItems: "center", flex: 1, justifyContent: "center", gap: 48, paddingBottom: 200 })}>
        ...
        <div style={flex({ background: "#FE392D", borderRadius: 999, paddingLeft: 48, paddingRight: 48, paddingTop: 16, paddingBottom: 16 })}>
          <span style={{ fontFamily: "Poppins", fontWeight: 700, fontSize: 28, color: "white", letterSpacing: 4 }}>NACHO TYPE</span>
        </div>
        ...
        <div style={flex({ background: "white", borderRadius: 32, paddingLeft: 56, paddingRight: 56, paddingTop: 36, paddingBottom: 36, maxWidth: 900, border: "4px solid #F0E8D0" })}>
          <span style={{ fontFamily: "Poppins", fontWeight: 700, fontSize: 72, color: "#333", textAlign: "center", lineHeight: 1.1 }}>{data.nachoType.name}</span>
        </div>

        {/* Subtitle */}
        <div style={flex({})}>
          <span style={{ fontFamily: "Poppins", fontWeight: 600, fontSize: 34, color: "#888", fontStyle: "italic" }}>zero out of ten, respectfully</span>
        </div>

        {/* Badge */}
        <div style={flex({ background: "#333", borderRadius: 999, paddingLeft: 48, paddingRight: 48, paddingTop: 20, paddingBottom: 20 })}>
          <span style={{ fontFamily: "Poppins", fontWeight: 700, fontSize: 30, color: "white" }}>
