...
function ResultsDishesPage() {
    ...
    async function handleShare() {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shareImage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shareImage"])(cardRef.current, "playte-results.png");
        } finally{
            setPreviewing(false);
            setSharing(false);
        }
...
_s(ResultsDishesPage, "c1Tec5mNi+6z5ALuNYG5SQ9O53Q=", false, function() {
    return [
...
//# sourceMappingURL=src_459ee437._.js.map