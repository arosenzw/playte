...
function ResultsDishesPage() {
    ...
    const [restaurantName, setRestaurantName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "ResultsDishesPage.useState": ()=>("TURBOPACK compile-time truthy", 1) ? sessionStorage.getItem(`restaurant_${id}`) ?? "" : "TURBOPACK unreachable"
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ResultsDishesPage.useEffect": ()=>{
            ...
            setTimeout({
                "ResultsDishesPage.useEffect": async ()=>{
            ...
            }["ResultsDishesPage.useEffect"], 800);
        }
    }["ResultsDishesPage.useEffect"], [
        data
    ]);
    async function handleShare() {
        ...
        setSharing(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$shareImage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shareBlob"])(cachedBlob.current, "playte-results.png");
        } finally{
            setSharing(false);
        }
    }
...
_s(ResultsDishesPage, "JCWBwXeNEY88e7d8Qpv7nq+kIOs=", false, function() {
    return [
...
//# sourceMappingURL=src_bfaa9f00._.js.map