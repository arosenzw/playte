...
"[project]/src/app/api/session/[id]/dishes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    ...
    try {
        ...
        if (!session || session.status !== "ranking") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Session not accepting dishes"
            }, {
                status: 400
            });
        }
        const dish = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dish.create({
            data: {
                sessionId: id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f566039c._.js.map